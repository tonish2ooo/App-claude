...
/** Tuile colorée contenant un emoji (rayon, avatar…). */
export function EmojiTile({
  ...
  return (
    <div
      className="flex shrink-0 items-center justify-center rounded-2xl bg-surface-subtle"
      style={{ width: size, height: size, fontSize: size * 0.5, ...(bg ? { background: bg } : {}) }}
    >
      {emoji}
    </div>
  );
